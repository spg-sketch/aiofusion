...
// answer (textarea, dual and dual-list) except 1.5, 1.7, 2.6, 2.7, 3.1, 3.2, 3.5 and
// the structured fields 1.8, 1.9 and 1.10. Short factual `text` fields, checkboxes and headings are excluded.
