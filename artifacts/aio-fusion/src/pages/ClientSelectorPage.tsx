          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {displayClients.map((client) => {
              ...
              return (
                <div
                  key={client.id}
                  className="group/card rounded-2xl flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-[3px] hover:ring-[#C8497A] cursor-pointer"
