    ...
    <div className="px-4 sm:px-8 py-8 sm:py-10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          <div key={s.label} className="rounded-2xl border p-4 sm:p-5 flex items-center gap-3.5 transition-all duration-300 bg-[rgba(201,74,62,0.08)] hover:-translate-y-2 hover:shadow-xl hover:ring-[3px] hover:ring-[#C8497A] hover:bg-[rgba(201,74,62,0.22)]" style={{ borderColor: "#e2e8f0" }}>
