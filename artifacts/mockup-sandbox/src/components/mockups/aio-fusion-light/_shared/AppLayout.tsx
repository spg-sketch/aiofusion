...
export function AppLayout({ children, currentPage, onNavigate }: AppLayoutProps) {
  return (
    <div className="flex h-screen w-full bg-white">
      <aside
        className="flex flex-col border-r w-[240px]"
      ...
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: isActive ? "var(--aio-accent)" : isLocked ? "var(--aio-gray-400)" : "var(--aio-gray-600)",
              ...
              >
                ...
                {isLocked && (
                  <span className="flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded"
                    style={{ background: "var(--aio-gray-100)", color: "var(--aio-gray-400)" }}>
                    <Lock size={10} /> V2
                  </span>
                )}
        ...
        <div className="px-3 py-4 border-t" style={{ borderColor: "var(--aio-gray-200)" }}>
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex flex-col">
              <span className="text-xs font-medium" style={{ color: "var(--aio-navy)" }}>Simpatico PR</span>
              <span className="text-[10px]" style={{ color: "var(--aio-gray-400)" }}>Intelligence Tier</span>
            </div>
          </div>
        </div>
      </aside>
