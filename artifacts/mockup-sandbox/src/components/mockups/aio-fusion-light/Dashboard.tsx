  ...
  return (
    <AppLayout currentPage="dashboard">
      <div className="px-8 py-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          <div className="rounded-xl p-5 border" style={{ background: "white", borderColor: "var(--aio-gray-200)" }}>
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: "rgba(79,143,255,0.08)" }}>
          ...
          <div className="rounded-xl p-5 border" style={{ background: "white", borderColor: "var(--aio-gray-200)" }}>
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: "rgba(124,92,255,0.08)" }}>
        ...
        <h2 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--aio-gray-400)" }}>
          Core Modules
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
