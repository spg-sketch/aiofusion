    ...
    <AppLayout currentPage="planner">
      <div className="px-8 py-8 max-w-5xl mx-auto">
        ...
        <div className="rounded-xl border overflow-hidden mb-6" style={{ background: "white", borderColor: "var(--aio-gray-200)" }}>
          <div className="p-6" style={{ background: "var(--aio-navy)" }}>
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="text-[11px] uppercase tracking-wider" style={{ color: "var(--aio-gray-400)" }}>
                      Plan Score
                    </span>
                  </div>
                </div>
              ...
              <div className="flex-1">
                <div className="grid grid-cols-3 gap-4">
                  <div className="rounded-lg p-3" style={{ background: "rgba(255,255,255,0.06)" }}>
                    <p className="text-[11px] uppercase tracking-wider mb-1" style={{ color: "var(--aio-gray-400)" }}>
                      Total Activations
                    </p>
                    <p className="text-2xl font-bold text-white">{categories.reduce((s, c) => s + c.count, 0)}</p>
                  </div>
                  <div className="rounded-lg p-3" style={{ background: "rgba(255,255,255,0.06)" }}>
                    <p className="text-[11px] uppercase tracking-wider mb-1" style={{ color: "var(--aio-gray-400)" }}>
                      Categories Active
              ...
              return (
                <div key={cat.id} className="px-5 py-4 flex items-center gap-4">
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0"
                    style={{ background: cat.count > 0 ? "rgba(34,197,94,0.08)" : "var(--aio-gray-100)" }}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs" style={{ color: "var(--aio-gray-400)" }}>
                          {cat.count} planned
                        </span>
                    ...
                    <div className="flex justify-between mt-1">
                      <span className="text-[11px]" style={{ color: "var(--aio-gray-400)" }}>
        ...
        <div className="rounded-xl border overflow-hidden" style={{ background: "white", borderColor: "var(--aio-gray-200)" }}>
          <div className="px-5 py-3 border-b flex items-center gap-2"
            style={{ background: "linear-gradient(135deg, rgba(34,197,94,0.06), rgba(79,143,255,0.06))", borderColor: "var(--aio-gray-200)" }}>
