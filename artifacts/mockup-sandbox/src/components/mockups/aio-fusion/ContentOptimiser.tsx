      ...
      <div className="px-8 py-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="rounded-xl border p-5 text-center" style={{ background: "white", borderColor: "var(--aio-gray-200)" }}>
            <p className="text-xs font-medium uppercase tracking-wider mb-1" style={{ color: "var(--aio-gray-500)" }}>
              Before
            </p>
            ...
            {trackedChanges.map((change, i) => (
              <div key={i} className="p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-semibold" style={{ color: "var(--aio-navy)" }}>
                    {change.label}
                  </span>
                </div>
                <div className="grid grid-cols-2 gap-4 mb-3">
                  {change.original && (
                    <div className="p-3 rounded-lg text-sm leading-relaxed" style={{ background: "#fef2f2", color: "#991b1b" }}>
                      <p className="text-[10px] font-semibold uppercase tracking-wider mb-1.5" style={{ color: "#dc2626" }}>
                        Original
                      </p>
                      {change.original}
                    </div>
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg" style={{ background: "var(--aio-gray-50)" }}>
                  ...
                  <p className="text-xs" style={{ color: "var(--aio-gray-600)" }}>
                    {change.annotation}
                  </p>
                </div>
              </div>
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium" style={{ color: "var(--aio-navy)" }}>
                        {phrase.phrase}
                      </span>
                    ...
                    <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "var(--aio-gray-100)" }}>
                      <div
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, #7c5cff, #4f8fff)`,
                        }}
                      />
                    </div>
                  </div>
